...
export const NavigationMenuPreview = () => {
  return (
    <div className="flex flex-col gap-12 w-full max-w-4xl justify-center items-center">
      <div className="space-y-4">
        <h3 className="text-sm font-semibold text-zinc-500 uppercase tracking-widest text-center">1. Mega Menu (Desktop)</h3>
                ...
                <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                  <li className="row-span-3">
                    <NavigationMenuLink asChild>
                      <a
                        className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-zinc-50/50 to-zinc-100 p-6 no-underline outline-none focus:shadow-md dark:from-zinc-900/50 dark:to-zinc-900"
                        href="/"
                      >
