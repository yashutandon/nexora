  ...
  <div className="flex flex-col gap-2 w-full max-w-sm">
    {transactions.map((t) => {
      ...
      return (
        <div
          key={t.name}
          className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl border border-black/5 dark:border-white/5 bg-zinc-50/50 dark:bg-zinc-800/40 hover:bg-zinc-100/60 dark:hover:bg-zinc-800 transition-colors duration-150"
        >
          <div className="flex items-center justify-center w-8 h-8 rounded-xl bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 shrink-0">
            {t.icon}
          </div>
          ...
          <p className={`text-[13.5px] font-semibold shrink-0 ${isCredit ? "text-emerald-600 dark:text-emerald-400" : "text-zinc-800 dark:text-zinc-200"}`}>
